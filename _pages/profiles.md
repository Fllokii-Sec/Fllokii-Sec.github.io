    ...
    <div class="toolbox-grid" style="display: flex; gap: 20px; flex-wrap: wrap; margin-bottom: 40px;">
      {% for tool in section.tools %}
        <div class="tool-item" style="text-align: center; width: 85px;">
          <!-- Fixed Shields.io URL path structure -->
          <img src="https://img.shields.io/badge/badge-{{ tool.color }}?style=square&logo={{ tool.icon | url_encode }}&logoColor=white&labelColor={{ tool.color }}" 
               width="70" 
               height="70" 
               alt="{{ tool.name }}" 
